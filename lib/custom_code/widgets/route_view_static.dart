...
class _RouteViewStaticState extends State<RouteViewStatic> {
  ...
  latlng.LatLng _startCoordinate;
  ...
  Future<bool> _calculateDistance() async {
    ...
    try {
      ...
      log('MAP::DISTANCE: $_placeDistance km');
  ...
  _createPolylines(
    ...
    log('MAP::STATUS: ${result.status}');
    log('MAP::POLYLINES: ${result.points.length}');
  ...
  @override
  void initState() {
    _startCoordinate = latlng.LatLng(
